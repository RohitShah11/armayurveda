...
.catalog-body{padding:18px}.catalog-price{color:var(--primary);font-weight:800;font-size:20px}.old-price{text-decoration:line-through;color:#999;font-size:14px}.category-pill{font-size:12px;background:var(--light);color:var(--primary);border-radius:20px;padding:5px 10px}
</style>
@endpush
@section('content')
<div class="container-fluid py-4">
  ...
  <div class="row g-4">
    ...
    <div class="col-sm-6 col-xl-3"><div class="catalog-card">
      @if($product->image)<img class="catalog-image" src="{{ Storage::disk('public')->url($product->image) }}" alt="{{ $product->name }}">@else<div class="catalog-placeholder"><i class="fa fa-box"></i></div>@endif
